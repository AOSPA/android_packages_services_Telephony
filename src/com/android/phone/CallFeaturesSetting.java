...
public class CallFeaturesSetting extends PreferenceActivity
    ...
    private static final String BUTTON_VIBRATE_ON_OUTGOING_PICKUP = "button_vibrate_outgoing_pickup";
    ...
    private CheckBoxPreference mButtonVibrateOnOutgoingPickup;
    ...
    public boolean onPreferenceTreeClick(PreferenceScreen preferenceScreen, Preference preference) {
        if (preference == mSubMenuVoicemailSettings) {
            ...
            return true;
        } else if (preference == mButtonVibrateOnOutgoingPickup) {
            return true;
    ...
    public boolean onPreferenceChange(Preference preference, Object objValue) {
        ...
        if (preference == mVibrateWhenRinging) {
            ...
            Settings.System.putInt(mPhone.getContext().getContentResolver(),
                    Settings.System.VIBRATE_ON_OUTGOING_PICKUP,
                    (Boolean) objValue ? 1 : 0);
    ...
    protected void onCreate(Bundle icicle) {
        ...
        mButtonVibrateOnOutgoingPickup =
                (CheckBoxPreference) findPreference(BUTTON_VIBRATE_ON_OUTGOING_PICKUP);
        ...
        if (mButtonVibrateOnOutgoingPickup != null) {
            mButtonVibrateOnOutgoingPickup.setOnPreferenceChangeListener(this);
        }
    ...
    protected void onResume() {
        ...
        if (mButtonVibrateOnOutgoingPickup != null) {
            int vibrateOnOutgoingPickup = Settings.System.getInt(getContentResolver(),
                    Settings.System.VIBRATE_ON_OUTGOING_PICKUP, 0);
            mButtonVibrateOnOutgoingPickup.setChecked(vibrateOnOutgoingPickup != 0);
        }
